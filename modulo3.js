...
document.getElementById("startQuizButton").addEventListener("click", function() {
    // Mostrar o quiz quando o botão for clicado
...
function submitQuiz() {
    ...
    const correctAnswers = {
        q1: 'a',  // A estrutura condicional correta para verificar várias condições
        q2: 'a',  // A palavra-chave usada no switch para verificar um valor
        q3: 'a',  // O comportamento de x > 10 && x < 20
        q4: 'a',  // O que acontece se não houver break no switch
        q5: 'a'   // Quando usar else if em vez de else
    };
...
function goToNextModule() {
    window.location.href = 'modulo4.html';  // Substitua pelo URL do próximo módulo
}
